...
// import {
//     Layout, TypographyTitle, LayoutContent, Divider, Tour, Card, CardMeta, Modal, Input,
...
app.use(pinia).use(router).directive('ctxmenu', VCtxmenu).use(Antd)
    // .use(Layout).use(TypographyTitle).use(LayoutContent).use(Divider).use(Tour).use(Card)
